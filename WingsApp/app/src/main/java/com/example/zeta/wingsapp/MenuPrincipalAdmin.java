...
public class MenuPrincipalAdmin extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView Usuario = (TextView) VistaHeader.findViewById(R.id.Usuario);
        Usuario.setText("Silvana");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent aSettings = new Intent (this, Settings.class);
            startActivity(aSettings);
        }

        return super.onOptionsItemSelected(item);
    }
 //------ACA MANEJAR LOS CLICKS A OPCIONES
